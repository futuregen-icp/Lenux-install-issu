...
## 작업 환경 변경
```
- 작업 구성을 10.0.xxx.xxx(라처송 과장님 의 registry 노드 접속)
...
- Basurl    >> 저장소 주소이다, 위에서는 register속 
  ftp:// 10.0.xxx.xxx/pub/repos/rhel-7-server-rpms 에 저장된 내용을 가져온다.
...
backend openshift-api-server
    balance source
    mode tcp
    server bootstrap 10.0.xxx.xxx:6443 check
    server master1 10.0.xxx.xxx:6443 check
##
...
backend machine-config-server
    balance source
    mode tcp
    server bootstrap 10.0.xxx.xxx:22623 check
    server master1 10.0.xxx.xxx:22623 check
...
backend ingress-http
    balance source
    mode tcp
    server worker1 10.0.xxx.xxx:80 check
...
#    balance source
    mode tcp
    server worker1 10.0.xxx.xxx:443 check
...
bastion ip : 10.0.xxx.xxx
 bootstrap ip : 10.0.xxx.xxx
 master01 ip : 10.0.xxx.xxx
 worker1 ip : 10.0.xxx.xxx
...
@       IN SOA  dns.ocp4-1.fu.te. root.ocp4-1.fu.te. (
                ...
                IN      A       10.0.xxx.xxx;
ns              IN      A       10.0.xxx.xxx;
bastion         IN      A       10.0.xxx.xxx;
;
bootstrap       IN      A       10.0.xxx.xxx;
;
master01        IN      A       10.0.xxx.xxx;
;
worker01        IN      A       10.0.xxx.xxx;
;
api             IN      A       10.0.xxx.xxx;
;
api-int         IN      A       10.0.xxx.xxx;
;
etcd-0          IN      A       10.0.xxx.xxx;
;
*.apps          IN      A       10.0.xxx.xxx;
;
